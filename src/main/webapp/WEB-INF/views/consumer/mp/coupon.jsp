...
<title>사용가능 쿠폰함</title>
</head>
<body>
	
<%-- ${coupondataList.get(0).consumer.consumer_nickname} --%>
<!-- array에 있는 0번쨰에 있는 consumer -->
...
<!-- 여기가 시작임 -->
   ...
   <div class="container-fluid px-4">
            ...
            <div class="row mt-4 ">
                <div class="col-6 text-center" ><a href="../mp/coupon?consumer_no=${consumer.consumer_no}" class="text-decoration-none"  style="color:coral">사용가능</a></div>
                <div class="col-6 text-center"><a href="../mp/couponDataExpiredList?consumer_no=${consumer.consumer_no }" class="text-decoration-none sub-grey">사용완료,만료</a></div>
            </div>
            <div class="row mb-4">
        ...
        <!-- 여기다가 쿠폰 -->
        <c:forEach items="${couponDataList}" var="data">
            ...
            <span class="border border-warning">
                <div class="row">
                    <div class="row bg-warning bg-opacity-25 " style="font-size: large;  font-style:bolder;margin-left: 0em;">전체 상품 쿠폰</div>
	                    ...
	                    <div class="col-4" style="place-self:center;"><img class="img-wrapper" src="/uploadFiles/${data.COUPON_IMG }"></div>
	                    <div class="col-8">
	                    <div class="row">
	                    
	                    <div class="row">
	                        <div class="col"></div>
	                        <div class="col-11"><p style="font-size: inherit;font-weight: lighter; margin-top: 1em;"> ${data.COUPON_NAME }</p></div>
	                    </div>
	                    <div class="row">
	                        <div class="row">
	                            <div class="col"></div>
	                            <div class="col-10"><p class="main-yellow" style="font-size: x-large;">${data.COUPON_SALEPRICE }원 할인</p></div>
	                        </div>
	                        <div class="row">
	                            <div class="col"></div>
	                            <div class="col-10">
	                            	<p class="sub-grey text-opacity-75" style="font-size: small;font-weight: bolder;">
	                            		<fmt:formatDate value="${data.COUPON_STARTDATE}" pattern="yy.MM.dd"/> ~ 
	                            		<fmt:formatDate value="${data.COUPON_LASTDATE}" pattern="yy.MM.dd"/>까지
	                           		</p>
	                       		</div>
	                        </div>
	                        <div class="row"></div>
...
<!-- 여기가 끝임 -->
      ...
      <%-- 	        	<p>${coupondataList.consumer.consumer_nickname }</p>  arrayList --%>
