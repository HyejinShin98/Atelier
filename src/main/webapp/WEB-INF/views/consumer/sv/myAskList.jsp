...
<body>
			...
			<div class="col d-grid">
				<table class="table">					
					...
					<tbody>	        			
						...
						<td style="width: 80%">
							<c:choose>				            				
							<c:when test="${qna.con_center_category_yn == 'y'}">
							...
							<a href="./myAskDetail?conCenterNo=${qna.con_center_no}">${qna.con_center_title }
							</a>				
						</td>
						<td><fmt:formatDate value="${qna.con_center_writedate }" pattern="yy.MM.dd"/></td>
						</tr>				      
					</tbody>
					</c:forEach>
				</table>
	...
	<div class="row mt-3">	
		...
		<div class="row mt-3">
			...
			<div class="col">
				<div class="float-end">
					<a href="./askWrite"><button type="button" class="btn btn-primary">문의하기</button></a>
				</div>
			</div>
		</div>
