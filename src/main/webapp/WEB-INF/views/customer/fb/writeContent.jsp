...
<div class="container-fluid px-3">
	...
	<div class="row">
           <div class="col">
               <div class="row">
                   <div class="col-3"></div>
                   <div class="col-6 fs-4 fw-bold text-center" >글쓰기</div>
                   <div class="col-3"></div>
               </div>
               <hr class="my-2">
		...
		<form action="./writeContentProcess" method="post" enctype="multipart/form-data">	
			<div class="row">		
				<div class="mb-3">
				  ...
				  <input name="freeboard_title" type="text" class="form-control" id="freeboard_title" placeholder="제목을 입력해주세요">
				</div>
				<div class="col">  	
	       			<div class="mt-2">
	           			<label for="exampleFormControlTextarea1" class="form-label">내용</label>
	           			<textarea input type name ="freeboard_content" class="form-control mt-1" id="exampleFormControlTextarea1" rows="8" placeholder="내용을 입력해주세요."></textarea>
	           		</div>           
           		</div>	       			
			</div>
			<div class="row">
