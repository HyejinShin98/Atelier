            ...
            <div class="col">
                <div class="input-group mb-3">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">사업자 번호</a></li>
                    </ul>    
        ...
        <div class="row">
            <div class="col">
                <table class="table">
                    ...
                    <tbody>
                      <c:forEach items="${cusList}" var="custList">
                       <tr>
                        <th scope="row">${custList.customer_no }</th>
                        <td>${custList.customer_id }</td>
                        <td>${custList.customer_name }</td>
                        <td>${custList.customer_business_number }</td>
                      </tr>
                      </c:forEach>
                    </tbody>
                  </table>
