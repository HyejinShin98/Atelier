		...
		<div class="row">
			<div class="col d-grid">
				<table class="table">					
					...
					<c:forEach items="${adCusAskList }" var="adCusAskList">				
						<tr>
							<td style="width: 10%">${adCusAskList.customerCenter.cus_center_no }</td>
							<td style="width: 50%">
								<c:choose>				            				
									<c:when test="${adCusAskList.customerCenter.cus_center_category_yn == 'y'}">
								...
								<a href="./customerAskDetail?cusCenterNo=${adCusAskList.customerCenter.cus_center_no }">${adCusAskList.customerCenter.cus_center_title }</a>
																									
								<div class="form-control-sm mx-0" >
									<span style="color: #6C6C6C">
										${adCusAskList.customer.customer_name}
									</span>
									<span style="color: #6C6C6C">
										<fmt:formatDate value="${adCusAskList.customerCenter.cus_center_writedate }" pattern="yy.MM.dd"/>
									</span>
								</div>											
						</tr>				      
					</c:forEach>
