...
<body>
	  <div class="container-fluid px-3">
	        ...
	        <div class="col d-grid">
	            <div class="card">
	                <div class="card-body mt-2">
	                  <div class="card-text">                      
	                    ${adCusAskData.customer.customer_name} 
	                  </div>
	                </div>
	            </div>
	        </div>
	    ...
	    <div class="row mt-2">
	        <div class="col d-grid">
	            <div class="card">
	                <div class="card-body mt-2">
	                  <div class="card-text">                      
	                     ${adCusAskData.customerCenter.cus_center_title }
	                  </div>
	                </div>
	            </div>
	        </div>
	    	...
	    	<div class="col d-grid">
	            <div class="card mt-2">
	                <div class="card-body">
	                  ...
	                  ${adCusAskData.customerCenter.cus_center_content }
	                  </div>
	                </div>
	            </div>
	        </div>
		...
		<c:choose>    
		<c:when test="${adCusAskData.admin.admin_no == null}">
			<div class="row mt-3">	
	    	...
	    	<div class="row mt-3">
		        <div class="col d-grid">					
					<a href="./customerAskUpdate?cusCenterNo=${adCusAskData.customerCenter.cus_center_no }" type="button" class="btn btn-warning">답변하기</a>					
				</div>                  					
            </div>
		</c:when>
		<c:otherwise>
	    ...
	    <div class="row mt-2">
	        <div class="col d-grid">
	            <div class="card">
	                <div class="card-body">
	                  <div class="card-text" style="min-height: 10rem;">                                      
	                  ${adCusAskData.customerCenter.cus_center_comment_by_admin }
	                  </div>
	                </div>
	            </div>
	        </div>
