...
<body>
	        ...
	        <div class="col d-grid">
	            <div class="card">
	                <div class="card-body mt-2">
	                  <div class="card-text">                      
	                    ${upAskData.consumer.consumer_nickname}
	                  </div>
	                </div>
	            </div>
	        </div>
	            ...
	            <div class="card">
	                <div class="card-body mt-2">
	                  <div class="textarea card-text">                      
	                      ${upAskData.consumerCenter.con_center_title}
	                  </div>
	                </div>
	            </div>
	        </div>
	    	...
	    	<div class="col d-grid">
	            <div class="card mt-2">
	                <div class="card-body">
	                  ...
	                  ${upAskData.consumerCenter.con_center_content}
	                  </div>
	                </div>
	            </div>
	        </div>
    ...
    <form action = "./consumerAskUpdateProcess" method="post">
    	<div class="row">
	        <div class="col">
		        <input type="hidden" name="con_center_no" value ="${upAskData.consumerCenter.con_center_no }">
	    ...
	    <div class="row">
	    	<div class="col d-grid">
	            <textarea class="form-control" id="exampleFormControlTextarea1" name="con_center_comment_by_admin" rows="8" placeholder="답변을 입력해주세요."></textarea>
	        </div>
	    </div>  
    <div class="row mt-3">
		<div class="col d-grid">					
