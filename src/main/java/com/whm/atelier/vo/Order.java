...
public class Order {
	 ...
	 * @param payment_no
	 * @param consumer_no
	 * @param order_complete_status
	 * @param order_delivery_status
	 * @param order_product_count
	 * @param order_date
	 * @param order_number
	 * @param address
	 */
	public Order(int order_no, int product_no, int payment_no, int consumer_no, String order_complete_status,
			String order_delivery_status, int order_product_count, Date order_date, String order_number, ConsumerAddress address) {
		super();
